```
@docs/Step 2 - Output 2 - SDD - HLD - LLD có cả Optimize Response Time.md 
@docs/Step 2 - Output 1 - SDD.md @docs/Step 2 - Output 3 - Caching 5 lớp.md 
Lên plan triển khai chi tiết code. 

Base on folder structure: 
@docs/template/2.0 v4 Output - SOFTWARE DESIGN DOCUMENT (SDD) - ULTIMATE TEMPLATE.md 
```
